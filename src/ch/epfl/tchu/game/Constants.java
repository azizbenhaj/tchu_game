...
public final class Constants {
    ...
    /**
     * Nombre de cartes joker.
     */
    public static final int JOKER_CARDS_COUNT = 8;
    /**
     * Nombre total de cartes wagon/locomotive.
     */
    public static final int TOTAL_CARDS_COUNT = JOKER_CARDS_COUNT+
    ...
    private static SortedBag<Card> computeAllCards() {
        ...
        cardsBuilder.add(JOKER_CARDS_COUNT, Card.JOKER);
