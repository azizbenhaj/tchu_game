...
class InfoTest {
    ...
    @Test
    void cardName() {
    System.out.println(Info.cardName(Card.BLUE,2).toString());
    System.out.println(Info.cardName(Card.RED,1).toString());
    }

    @Test
    void draw() {
        List<String> playerNames=List.of("Aziz Laadhar","Ahmed Aziz BEN HAJ HMIDA","Mohsen");
        System.out.println(Info.draw(playerNames,(6)));
    }

    @Test
    void willPlayFirst() {
        Info name =new Info("Aziz");

        System.out.println(name.willPlayFirst());
    }
    ...
    void keptTickets() {
        ...
        System.out.println(name.keptTickets(5));
    }
    ...
    void canPlay() {
        ...
        System.out.println(name.canPlay());
    }
    ...
    void drewTickets() {
        ...
        System.out.println(name.drewTickets(5));
    }
    ...
    void drewBlindCard() {
        ...
        System.out.println(name.drewBlindCard());
    }
    ...
    void drewVisibleCard() {
        ...
        System.out.println(name.drewVisibleCard(Card.ORANGE));
    }
    ...
    void claimedRoute() {
        ...
        Route route=new Route("BAL_DEL_1", new Station(4,"BALE"),
                new Station(5,"GENEVE"), 2, Route.Level.UNDERGROUND, Color.YELLOW);
        SortedBag<Card> cartes=SortedBag.of(2,Card.LOCOMOTIVE,1,Card.WHITE);
        System.out.println(name.claimedRoute(route,cartes));
    ...
    void attemptsTunnelClaim() {
        Info name =new Info("Aziz");
        Route route=new Route("BAL_DEL_1", new Station(4,"LAUSANNE"),
                new Station(5,"GENEVE"), 2, Route.Level.UNDERGROUND, Color.YELLOW);
        SortedBag<Card> cartes=SortedBag.of(10,Card.RED,1,Card.LOCOMOTIVE);
        System.out.println(name.attemptsTunnelClaim(route,cartes));
    }

    @Test
    void drewAdditionalCardsWithCost() {
        Info name =new Info("Aziz");
        SortedBag<Card> cartes=SortedBag.of(10,Card.RED,1,Card.LOCOMOTIVE);
        System.out.println(name.drewAdditionalCards(cartes,5));
    }
    @Test
    void drewAdditionalCardsWithoutCost() {
        Info name =new Info("Aziz");
        SortedBag<Card> cartes=SortedBag.of(10,Card.RED,1,Card.LOCOMOTIVE);
        System.out.println(name.drewAdditionalCards(cartes,0));
    }
    ...
    void didNotClaimRoute() {
        ...
        Route route=new Route("BAL_DEL_1", new Station(4,"LAUSANNE"),
                new Station(5,"GENEVE"), 2, Route.Level.UNDERGROUND, Color.YELLOW);
        System.out.println(name.didNotClaimRoute(route));
    }

    @Test
    void lastTurnBegins() {
        Info name =new Info("Aziz");
        System.out.println(name.lastTurnBegins(3));
    }
    ...
    void getsLongestTrailBonus() {
        ...
        System.out.println(name.getsLongestTrailBonus(trail));
    }

    @Test
    void won() {
        Info name =new Info("Aziz");
        System.out.println(name.won(5,1));
    }
}*/
