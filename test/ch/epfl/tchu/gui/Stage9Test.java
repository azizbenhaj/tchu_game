...
public final class Stage9Test extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ObjectProperty<ActionHandlers.DrawTicketsHandler> drawTickets =
                new SimpleObjectProperty<>(Stage9Test::drawTicket);
        ...
        Node infoView = InfoViewCreator.createInfoView(PLAYER_1, new HashMap<>(Map.of(PLAYER_1, "Ada", PLAYER_2, "Charles")), gameState, FXCollections.observableList(List.of(new Text("Première information"), new Text("Seconde information"))));
    ...
    /*private static void chooseTickets(SortedBag<Ticket> tickets) {
        System.out.println("Tirage de billets !");
    }*/

   /* private static void chooseCards(SortedBag<Card> cards) {
        System.out.println("Tirage de cartes !");
    }*/
  ...
  /*  private static void drawCard(int slot) {
    ...
    private static void drawTicket() {
        System.out.println("Tirage de billet");
    }
