...
class PlayerStateTest {
    ...
    @Test
    void initial() {
        SortedBag<Card> sb=SortedBag.of(2,Card.RED,2,Card.BLUE);
    PlayerState player=PlayerState.initial(sb);
    ...
    @Test
    void initialException() {
        SortedBag<Card> sb=SortedBag.of(2,Card.RED,3,Card.BLUE);
        assertThrows(IllegalArgumentException.class, () -> {PlayerState.initial(sb);
        });
    }
    ...
    void tickets() {
        ...
        var t1 = new Ticket(List.of(new Trip(s1, s2, 15)));
        var t2 = new Ticket(List.of(new Trip(s1, s2, 16)));
        PlayerState player=new PlayerState(SortedBag.of(1,t1,5,t2),SortedBag.of(2,Card.RED,3,Card.BLUE),List.of());
        System.out.println(player.tickets().toString());
        assertEquals(6,player.tickets().size());
    }
    ...
    void withAddedTickets() {
        ...
        var t1 = new Ticket(List.of(new Trip(s1, s2, 15)));
        var t2 = new Ticket(List.of(new Trip(s1, s2, 16)));
        var t3 = new Ticket(List.of(new Trip(s1, s2, 17)));
        var t4 = new Ticket(List.of(new Trip(s1, s2, 18)));
        PlayerState player=new PlayerState(SortedBag.of(1,t1,5,t2),SortedBag.of(2,Card.RED,3,Card.BLUE),List.of());
        System.out.println(player.withAddedTickets(SortedBag.of(2,t3,3,t4)).tickets().toString());
        assertEquals(11,player.withAddedTickets(SortedBag.of(2,t3,3,t4)).tickets().size());
    }

    @Test
    void cards() {
        PlayerState player=new PlayerState(SortedBag.of(),SortedBag.of(2,Card.RED,3,Card.BLUE),List.of());
    ...
    void withAddedCard() {
        PlayerState player=new PlayerState(SortedBag.of(),SortedBag.of(2,Card.RED,3,Card.BLUE),List.of());
        System.out.println(player.withAddedCard(Card.BLACK).cards().toString());
        assertEquals(6,player.withAddedCard(Card.BLACK).cards().size());
    }

    @Test
    void withAddedCards() {
        PlayerState player=new PlayerState(SortedBag.of(),SortedBag.of(2,Card.RED,3,Card.BLUE),List.of());
        System.out.println(player.withAddedCards(SortedBag.of(6,Card.WHITE,5,Card.YELLOW)).cards().toString());
        assertEquals(16,player.withAddedCards(SortedBag.of(6,Card.WHITE,5,Card.YELLOW)).cards().size());
    }

   // @Test
    //pour tester il faut changer les bornes de longueur de la route
    /*void canClaimRoute() {
        var s1 = new Station(0, "Lausanne");
        var s2 = new Station(1, "EPFL");
        Route route= new Route("id", s1, s2, 38, Route.Level.OVERGROUND, Color.BLACK);
        PlayerState player=new PlayerState(SortedBag.of(),SortedBag.of(2,Card.RED,3,Card.BLACK),List.of(route));
        assertEquals(true,player.canClaimRoute(new Route("id", s1, s2, 2, Route.Level.OVERGROUND, Color.BLACK)));
   ...
   /* @Test
    void possibleClaimCards() {
        //il y'a une difference entre route UNDERGROUND et OVERGROUND voir methode possibleCardsClaim de Route
        var s1 = new Station(0, "Lausanne");
        var s2 = new Station(1, "EPFL");
        Route route= new Route("id", s1, s2, 4, Route.Level.UNDERGROUND, Color.RED);
        PlayerState player=new PlayerState(SortedBag.of(),SortedBag.of(5,Card.LOCOMOTIVE,1,Card.BLACK),List.of(route));
        Route route1= new Route("id", s1, s2, 5, Route.Level.UNDERGROUND, Color.BLACK);
        System.out.println(player.possibleClaimCards(route1).toString());
    }
   ...
   // @Test
    ...
    /*void possibleClaimCardsException() {
        var s1 = new Station(0, "Lausanne");
        var s2 = new Station(1, "EPFL");
        Route route= new Route("id", s1, s2, 38, Route.Level.UNDERGROUND, Color.RED);
        PlayerState player=new PlayerState(SortedBag.of(),SortedBag.of(5,Card.LOCOMOTIVE,1,Card.BLACK),List.of(route));
        Route route1= new Route("id", s1, s2, 3, Route.Level.UNDERGROUND, Color.BLACK);
        assertThrows(IllegalArgumentException.class, () -> {player.possibleClaimCards(route1);
        });
    }*/
   ...
   /* @Test
    void possibleAdditionalCards() {
        ...
        var s2 = new Station(1, "EPFL");
        Route route= new Route("id", s1, s2, 4, Route.Level.UNDERGROUND, Color.RED);
        PlayerState player=new PlayerState(SortedBag.of(),SortedBag.of(2,Card.LOCOMOTIVE,3,Card.RED),List.of(route));
        SortedBag<Card> initialCards=SortedBag.of(1,Card.RED,1,Card.LOCOMOTIVE);
        System.out.println(player.possibleAdditionalCards(2,initialCards,SortedBag.of(3,Card.RED)));
    }

    @Test
    void possibleAdditionalCardsException() {
        var s1 = new Station(0, "Lausanne");
        var s2 = new Station(1, "EPFL");
        Route route= new Route("id", s1, s2, 4, Route.Level.UNDERGROUND, Color.RED);
        PlayerState player=new PlayerState(SortedBag.of(),SortedBag.of(5,Card.LOCOMOTIVE,1,Card.BLACK),List.of(route));
        SortedBag<Card> sor=SortedBag.of(1,Card.BLUE);
        assertThrows(IllegalArgumentException.class, () -> {player.possibleAdditionalCards(2,player.cards().union(sor),SortedBag.of(3,Card.WHITE));
        });
    }
    ...
    void withClaimedRoute() {
        ...
        var s2 = new Station(1, "EPFL");
        Route route= new Route("id", s1, s2, 4, Route.Level.UNDERGROUND, Color.RED);
        PlayerState player=new PlayerState(SortedBag.of(),SortedBag.of(2,Card.RED,3,Card.BLUE),List.of(route));
        Route route2= new Route("id", s1, s2, 3, Route.Level.UNDERGROUND, Color.RED);
        SortedBag<Card>claim=SortedBag.of(1,Card.RED,1,Card.BLUE);
        System.out.println(player.withClaimedRoute(route2, claim).routes().toString());
        System.out.println(player.withClaimedRoute(route2, claim).cards().toString());
        //assertEquals(6,player.withAddedCard(Card.BLACK).cards().size());
    }
    ...
    void ticketPoints() {
        ...
        var s2 = new Station(1, "EPFL");
        Route route= new Route("id", s1, s2, 4, Route.Level.UNDERGROUND, Color.RED);
        PlayerState player=new PlayerState(SortedBag.of(1,new Ticket(s1,s2,15),1,new Ticket(s1,s2,18)),SortedBag.of(2,Card.RED,3,Card.BLUE),List.of(route));
        System.out.println(player.ticketPoints());
    }
    ...
    void finalPoints() {
        var s1 = new Station(0, "Lausanne");
        var s2 = new Station(1, "EPFL");
        Route route= new Route("id", s1, s2, 6, Route.Level.UNDERGROUND, Color.RED);
        PlayerState player=new PlayerState(SortedBag.of(1,new Ticket(s1,s2,15),1,new Ticket(s1,s2,18)),SortedBag.of(2,Card.RED,3,Card.BLUE),List.of(route));
        assertEquals(48,player.finalPoints());
    }
}*/
package ch.epfl.tchu.game;
