...
class DeckTest {
    ...
    void of() {
        ...
        System.out.println(Deck.of(cards,new Random()).getCards());
       // assertEquals(null,Deck.of(cards,new Random()).getCards());
    }
  ...
  /*  @Test
    void topCard() {
       ...
       // assertEquals("dame de cœur",deck.topCard().toString());
    }

    @Test
    void withoutTopCard() {
        SortedBag<String> cards = SortedBag.of(3, "as de pique",5, "dame de cœur" );
       // SortedBag<String> cards1 = SortedBag.of(2, "as de pique",5, "dame de cœur" );
        Deck deck =Deck.of(cards,new Random());
        System.out.println(deck.getCards());
        //System.out.println(cards1);
        System.out.println(deck.withoutTopCard().getCards());
       // assertEquals(null,deck.withoutTopCard().getCards().toString());
    }
    @Test
    void withoutTopCardIllegalArgumentException() {
        SortedBag<String> cards = SortedBag.of( );
        Deck deck =Deck.of(cards,new Random());
    ...
    void topCards() {
        ...
        assertEquals(5,deck.topCards(5).size());
    }

    @Test
    void topCardsException() {
        SortedBag<String> cards = SortedBag.of(3, "as de pique", 5, "dame de cœur");
        Deck deck = Deck.of(cards, new Random());
    ...
    void withoutTopCards() {
        ...
        Deck deck = Deck.of(cards, new Random());
        System.out.println(deck.getCards());
        System.out.println(deck.withoutTopCards(3).getCards());
        assertEquals(5,deck.withoutTopCards(3).getCards().size());
    }

    @Test
    void withoutTopCardsException() {
        SortedBag<String> cards = SortedBag.of(3, "as de pique", 5, "dame de cœur");
        Deck deck = Deck.of(cards, new Random());
