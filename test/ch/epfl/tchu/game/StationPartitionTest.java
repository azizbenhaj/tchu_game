...
class StationPartitionTest {
    ...
    void profonde(){
        ...
        Station DEL = new Station(1, "Delémont");
        Station FRI = new Station(2, "Fribourg");
        Station INT = new Station(3, "Interlaken");
        Station LAU = new Station(5, "Lausanne");
        Station LCF = new Station(4, "La Chaux-de-Fonds");
        Station LUC = new Station(6, "Lucerne");
        Station NEU = new Station(7, "Neuchâtel");
        Station OLT = new Station(8, "Olten");
        Station SCZ = new Station(9, "Schwyz");
        Station SOL = new Station(10, "Soleure");
        Station WAS = new Station(11, "Wassen");
        Station YVE = new Station(12, "Yverdon");
        Station ZOU = new Station(13, "Zoug");
        Station ZUR = new Station(14, "Zürich");
        List<Station> liste=List.of(BER,DEL,FRI,INT,LAU,LCF,LUC,NEU,OLT,SCZ,SOL,WAS,YVE,ZOU,ZUR);
        StationPartition.Builder builder=new StationPartition.Builder(15);
        builder.connect(BER,FRI);
        builder.connect(BER,INT);
        builder.connect(BER,LAU);
        builder.connect(NEU,SOL);
        builder.connect(NEU,OLT);
        builder.connect(LUC,ZOU);
        builder.connect(LUC,SCZ);
        builder.connect(LUC,WAS);
        StationPartition var=builder.build();
