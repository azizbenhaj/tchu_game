...
class PublicCardStateTest {
  ...
  /*  @Test
    void PublicCardStateException(){
        List<Card> faceUpCards=List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE);
        int deckSize=1;
        int discardsSize=1;
        assertThrows(IllegalArgumentException.class,() ->{new PublicCardState(faceUpCards,deckSize,discardsSize);
        });
    }
    ...
    @Test
    void totalSize() {
        List<Card> faceUpCards=List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE);
        int deckSize=50;
        int discardsSize=500;
        PublicCardState s=new PublicCardState(faceUpCards,deckSize,discardsSize);
        assertEquals(555,s.totalSize());
    }

    @Test
    void faceUpCards() {
        List<Card> faceUpCards=List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.RED,Card.LOCOMOTIVE);
        int deckSize=5;
        int discardsSize=50;
        PublicCardState s=new PublicCardState(faceUpCards,deckSize,discardsSize);
        assertEquals("[LOCOMOTIVE, LOCOMOTIVE, LOCOMOTIVE, RED, LOCOMOTIVE]",s.faceUpCards().toString());
    }
    ...
    void faceUpCard() {
        ...
        int discardsSize=50;
        PublicCardState s=new PublicCardState(faceUpCards,deckSize,discardsSize);
        assertEquals("RED",s.faceUpCard(3).toString());
    ...
    void isDeckEmpty() {
        ...
        int discardsSize=50;
        PublicCardState s=new PublicCardState(faceUpCards,deckSize,discardsSize);
        assertEquals(true,s.isDeckEmpty());
    }
    ...
    void discardsSize() {
        ...
        int discardsSize=50;
        PublicCardState s=new PublicCardState(faceUpCards,deckSize,discardsSize);
        assertEquals(50,s.discardsSize());
    }
}*/
package ch.epfl.tchu.game;
