...
class GameTest {
    ...
    @Test
    void play() {
        PlayerTest a=new PlayerTest(0,ChMap.routes());
        PlayerTest b=new PlayerTest(0,ChMap.routes());
        Map<PlayerId,Player> players=Map.of(PlayerId.PLAYER_1, a,PlayerId.PLAYER_2,b);

        Map<PlayerId, String> playerNames=Map.of(PlayerId.PLAYER_1, "aziz1",PlayerId.PLAYER_2,"aziz2");
...
//    }
    ...
    void gamePlayCallsUpdateStateOftenEnough() {
       ...
       // System.out.println(updateState1);
    }
    ...
    void gamePlayCallsChooseTicketsWhenPlayerDrawsTickets() {
        ...
        for (var player : playRandomGame(2025)) {
           ...
           // assertEquals(drawTicketsTurnsCount, chooseTicketsCallsCount);
            ...
            System.out.println(drawTicketsTurnsCount);
        }

        var allTicketsBag = SortedBag.of(ChMap.ALL_TICKETS);
        System.out.println(allTicketsBag.size());
    ...
    private static final class TestPlayer implements Player {
        ...
        public void setInitialTicketChoice(SortedBag<Ticket> tickets) {
           ...
           // System.out.println(allTicketsSeen);
        }

        @Override
        public SortedBag<Ticket> chooseInitialTickets() {
            registerCall(PlayerMethod.CHOOSE_INITIAL_TICKETS);
            //System.out.println(allTicketsSeen.peekFirst());
        ...
        private TurnKind doNextTurn() {
            ...
            { System.out.println("i want to draw tickets");
