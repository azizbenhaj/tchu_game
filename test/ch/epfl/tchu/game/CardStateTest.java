...
class CardStateTest {
    ...
    @Test
    void of() {
        SortedBag<String> cards = SortedBag.of(3, "as de pique", 5, "dame de cœur");
        Deck deck = Deck.of(cards, new Random());
        CardState state = CardState.of(deck);
        //assertEquals(null,state.faceUpCards());
        System.out.println(state.faceUpCards());
        System.out.println(state.deckCard().getCards());
        System.out.println(state.discardCards());
        assertEquals(3, state.deckCard().getCards().size());

    }

    @Test
    void ofIAE() {
        SortedBag<String> cards = SortedBag.of(3, "as de pique", 1, "dame de cœur");
        Deck deck = Deck.of(cards, new Random());
    ...
    void withDrawnFaceUpCard() {
        SortedBag<Card> cards = SortedBag.of(3, Card.BLUE, 5, Card.LOCOMOTIVE);
        Deck deck = Deck.of(cards, new Random());
        CardState state = CardState.of(deck);
        CardState state1 = state.withDrawnFaceUpCard(2);
        System.out.println(state1.deckSize());
        System.out.println(state1.faceUpCards().size());
        System.out.println(state1.totalSize());
    }

    @Test
    void withDrawnFaceUpCardIndexOutOfBoundsException() {
        SortedBag<Card> cards = SortedBag.of(3, Card.BLUE, 5, Card.LOCOMOTIVE);
        Deck deck = Deck.of(cards, new Random());
        CardState state = CardState.of(deck);
    ...
    @Test
    void withDrawnFaceUpCardIllegalArgumentException() {
        SortedBag<Card> cards = SortedBag.of(3, Card.BLUE, 2, Card.LOCOMOTIVE);
        Deck deck = Deck.of(cards, new Random());
        CardState state = CardState.of(deck);
        assertThrows(IllegalArgumentException.class, () -> {
            state.withDrawnFaceUpCard(2);
        });
    }

    @Test
    void topDeckCard() {
        SortedBag<Card> cards = SortedBag.of(5, Card.BLUE, 2, Card.LOCOMOTIVE);
        Deck deck = Deck.of(cards, new Random());
        CardState state = CardState.of(deck);
        System.out.println(state.topDeckCard());
        // assertEquals(Card.BLUE,state.topDeckCard());
    }

    @Test
    void topDeckCardIllegalArgumentException() {
        SortedBag<Card> cards = SortedBag.of(3, Card.BLUE, 2, Card.LOCOMOTIVE);
        Deck deck = Deck.of(cards, new Random());
        CardState state = CardState.of(deck);
        assertThrows(IllegalArgumentException.class, () -> {
    ...
    void withoutTopDeckCard() {
        SortedBag<Card> cards = SortedBag.of(1, Card.BLUE, 5, Card.LOCOMOTIVE);
        Deck deck = Deck.of(cards, new Random());
        CardState state = CardState.of(deck);
        System.out.println(state.withoutTopDeckCard().deckCard().getCards());

    }

    @Test
    void withoutTopDeckCardIllegalArgumentException() {
        SortedBag<Card> cards = SortedBag.of(2, Card.BLUE, 3, Card.LOCOMOTIVE);
        Deck deck = Deck.of(cards, new Random());
        CardState state = CardState.of(deck);
        assertThrows(IllegalArgumentException.class, () -> {
            state.withoutTopDeckCard();
        });
    }
   ...
   /* @Test
    void withDeckRecreatedFromDiscards() {
        ...
        System.out.println(state.withDeckRecreatedFromDiscards(new Random()).deckSize());


    }*/

   /* @Test
    void withDeckRecreatedFromDiscardsIllegalArgumentException() {
        SortedBag<Card> cards = SortedBag.of(3, Card.BLUE,7, Card.LOCOMOTIVE);
        Deck deck = Deck.of(cards,new Random());
        CardState state=CardState.of(deck);
        assertThrows(IllegalArgumentException.class,() ->{state.withDeckRecreatedFromDiscards(new Random());
        });
    }
    ...
    void withMoreDiscardedCards() {
        ...
        Deck deck = Deck.of(cards,new Random());
        CardState state=CardState.of(deck);
        System.out.println(state.discardsSize());
        System.out.println(state.withMoreDiscardedCards(SortedBag.of(2, Card.RED,2, Card.YELLOW)).discardsSize());
...
import ch.epfl.tchu.SortedBag;
import ch.epfl.tchu.game.TestRandomizer;
import org.junit.jupiter.api.Test;
