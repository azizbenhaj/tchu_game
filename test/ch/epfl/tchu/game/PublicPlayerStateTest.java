...
class PublicPlayerStateTest {
    ...
    @Test
    void constructeur(){
        assertThrows(IllegalArgumentException.class,() ->{new PublicPlayerState(1,-1,null);
        });
    }
    @Test
    void ticketCount() {
        PublicPlayerState var=new PublicPlayerState(5,6,null);
        assertEquals(5,var.ticketCount());
    }

    @Test
    void cardCount() {
        PublicPlayerState var=new PublicPlayerState(5,6,null);
        assertEquals(6,var.cardCount());
    }

    @Test
    void routes() {
        List<Route> ALL_ROUTES = List.of(
                new Route("AT1_STG_1",new Station(19, "Neuchâtel"), new Station(10, "Neuchâtel"), 4, Route.Level.UNDERGROUND, null),
                new Route("AT2_VAD_1", new Station(14, "Neuchâtel"), new Station(15, "Neuchâtel"), 1, Route.Level.UNDERGROUND, Color.RED));
        PublicPlayerState var=new PublicPlayerState(5,6,ALL_ROUTES);
        assertEquals(ALL_ROUTES,var.routes());
    }
    ...
    void claimPoints() {
        List<Route> ALL_ROUTES = List.of(
                new Route("AT1_STG_1",new Station(19, "Neuchâtel"), new Station(10, "Neuchâtel"), 4, Route.Level.UNDERGROUND, null),
                new Route("AT2_VAD_1", new Station(14, "Neuchâtel"), new Station(15, "Neuchâtel"), 4, Route.Level.UNDERGROUND, Color.RED));
        PublicPlayerState var=new PublicPlayerState(5,6,ALL_ROUTES);

        assertEquals(14,var.claimPoints());
    }
    }*/
package ch.epfl.tchu.game;
