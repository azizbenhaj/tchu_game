...
class PublicGameStateTest {
    ...
    void constructeurException(){
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE),
                3,3);
        PublicPlayerState playerstate1 = new PublicPlayerState(5,5,List.of());
        PublicPlayerState playerstate2 = new PublicPlayerState(5,5,List.of());
        Map<PlayerId, PublicPlayerState> playerState=Map.of(PlayerId.PLAYER_1,playerstate1,PlayerId.PLAYER_2,playerstate2);

        assertThrows(NullPointerException.class, () -> {new PublicGameState(5,card,null, playerState,PlayerId.PLAYER_2);
        });
    }
    ...
    void ticketsCount() {
        ...
        PublicPlayerState playerstate2 = new PublicPlayerState(5,5,List.of());
        Map<PlayerId, PublicPlayerState> playerState=Map.of(PlayerId.PLAYER_1,playerstate1,PlayerId.PLAYER_2,playerstate2);
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE), 3,3);
        PublicGameState game = new PublicGameState(2,card,PlayerId.PLAYER_1, playerState ,PlayerId.PLAYER_2);
        assertEquals(2,game.ticketsCount());
    }
    ...
    void canDrawTickets() {
        ...
        Map<PlayerId, PublicPlayerState> playerState=Map.of(PlayerId.PLAYER_1,playerstate1,PlayerId.PLAYER_2,playerstate2);
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE), 3,3);
        PublicGameState game1 = new PublicGameState(1,card,PlayerId.PLAYER_1, playerState ,PlayerId.PLAYER_2);
        assertEquals(true,game1.canDrawTickets());
    }
    ...
    void cardState() {
        ...
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE), 3,3);
        PublicGameState game1 = new PublicGameState(1,card,PlayerId.PLAYER_1, playerState ,PlayerId.PLAYER_2);
        System.out.println(game1.cardState().faceUpCards().toString());
    }
    ...
    void canDrawCards() {
        ...
        PublicPlayerState playerstate2 = new PublicPlayerState(5,5,List.of());
        Map<PlayerId, PublicPlayerState> playerState=Map.of(PlayerId.PLAYER_1,playerstate1,PlayerId.PLAYER_2,playerstate2);
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE), 3,2);
        PublicGameState game1 = new PublicGameState(1,card,PlayerId.PLAYER_1, playerState ,PlayerId.PLAYER_2);
        assertEquals(true,game1.canDrawCards());
    }
    ...
    void currentPlayerId() {
        ...
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE), 3,3);
        PublicGameState game1 = new PublicGameState(1,card,PlayerId.PLAYER_1, playerState ,PlayerId.PLAYER_2);
        System.out.println(game1.currentPlayerId());
    }
    ...
    void playerState() {
        ...
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE), 3,3);
        PublicGameState game1 = new PublicGameState(1,card,PlayerId.PLAYER_1, playerState ,PlayerId.PLAYER_2);
        assertEquals(playerstate1,game1.playerState(PlayerId.PLAYER_1));
    }
    ...
    void currentPlayerState() {
        ...
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE), 3,3);
        PublicGameState game1 = new PublicGameState(1,card,PlayerId.PLAYER_1, playerState ,PlayerId.PLAYER_2);
        assertEquals(playerstate1,game1.playerState(game1.currentPlayerId()));
    }
    ...
    void claimedRoutes() {
        ...
        PublicPlayerState playerstate1 = new PublicPlayerState(5,5,List.of(
                new Route("AT1_STG_1", IT1, IT2, 4, Route.Level.UNDERGROUND, null),
                new Route("AT2_VAD_1", IT2, IT1, 1, Route.Level.UNDERGROUND, Color.RED)
        ));
        PublicPlayerState playerstate2 = new PublicPlayerState(5,5,List.of(
                new Route("BAD_BAL_1", IT1, IT2, 3, Route.Level.UNDERGROUND, Color.RED),
                new Route("BAD_OLT_1",IT1, IT2, 2, Route.Level.OVERGROUND, Color.VIOLET),
                new Route("BAD_ZUR_1", IT1, IT2, 1, Route.Level.OVERGROUND, Color.YELLOW),
                new Route("BAL_DE1_1", IT1, IT2, 1, Route.Level.UNDERGROUND, Color.BLUE)
        ));
        Map<PlayerId, PublicPlayerState> playerState=Map.of(PlayerId.PLAYER_1,playerstate1,PlayerId.PLAYER_2,playerstate2);
        ...
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE),
                3,3);
        PublicGameState game1 = new PublicGameState(1,card,PlayerId.PLAYER_1, playerState ,PlayerId.PLAYER_2);
        assertEquals(6,game1.claimedRoutes().size());
    }
    ...
    void lastPlayer() {
        ...
        PublicCardState card=new PublicCardState(List.of(Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE,Card.LOCOMOTIVE), 3,3);
        PublicGameState game1 = new PublicGameState(1,card,PlayerId.PLAYER_1, playerState ,PlayerId.PLAYER_2);
        assertEquals(PlayerId.PLAYER_2,game1.lastPlayer());
    }
}*/
package ch.epfl.tchu.game;
